...
const CACHE_NAME = "ecopontos-beta-v1-20260724";

const URLs_TO_CACHE = [
    '/ecoponto-beta/',
    '/ecoponto-beta/index.html',
    '/ecoponto-beta/configuracao.html',
    '/ecoponto-beta/registros.html',
    '/ecoponto-beta/script.js',
    '/ecoponto-beta/registros.js',
    '/ecoponto-beta/notificacoes.js',
    '/ecoponto-beta/configuracao.js',
    '/ecoponto-beta/campos-schema.js',
    '/ecoponto-beta/campos.js',
    '/ecoponto-beta/logotipo.png',
    '/ecoponto-beta/offline.html',
];
        ...
        fetch(event.request).then((networkResponse) => {
            ...
            return caches.match(event.request).then((cachedResponse) => {
                ...
                if (event.request.mode === 'navigate') {
                    return caches.match('/ecoponto-beta/offline.html');
                }
